...
angular.module('owsWalletPlugin.controllers').controller('SettingsCtrl', function($scope, $timeout, $state, $ionicHistory, gettextCatalog, Session, popupService, externalLinkService, coinbaseService) {
